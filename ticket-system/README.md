...
> **Atrás de um *proxy* corporativo** que intercepta TLS? Se o build falhar com
> `SELF_SIGNED_CERT_IN_CHAIN`, arranque com `NPM_STRICT_SSL=false docker compose up --build`
> (a verificação de TLS mantém-se activa por omissão; isto só a desliga para a
